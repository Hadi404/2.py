# Ustad# HADI# AloneBoy# Hadi-Shah# Gamz#!/usr/bin/python2
#coding=utf-8
...
\033[1;92m---------------------BRAND---------------------
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mTHE ULTIMATE HADI SHAH..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91mDEVOLPER
                     HADI-SHAH
\033[1;94mFACEBOOK
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:hadi-shah
	    time.sleep(2)
            loop = 'false'
        else:
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1]  START CLONING With HADI'
    time.sleep(0.10)
    print '\x1b[1;92m[2] HADI FB ACCOUNT'
    time.sleep(0.10)
